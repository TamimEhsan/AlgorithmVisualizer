...
import {invertBit} from '../algorithms/turing';
...
class TuringMachine extends Component {
    ...
    handleAlgo = async ()=>{
        ...
        while(state!='qe'){
            ...
            await sleep(500);
            read = read.toString();
            let [nextState,write,dir] = invertBit(state,read);
            let strip = [...this.state.strip];
            ...
            <div>
                ...
                <div className='row'>
                    <div className="input-group mt-2 col-3">
                        <input type="text" id='inputText1' className="form-control" placeholder="Input Binary" aria-label="Username"
                               aria-describedby="basic-addon1"
                                onChange={this.setInput1}
                        />
                    </div>
                    <div className="input-group mt-2 col-3">
                        <input type="text" id='inputText1' className="form-control" placeholder="Input Binary 2" aria-label="Username"
                               aria-describedby="basic-addon1"/>
                    </div>
                </div>
